== Nelson ==
Version: 1.0
Copyright: 2019, Nelson
WordPress version: required at least 4.7, tested up to 5.2
...
Please install and activate it before starting to use the theme Nelson.
...
Theme documentation is available on http://nelson.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Nelson is Fontello.
