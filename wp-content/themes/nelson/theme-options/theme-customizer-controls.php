...
// 'info' field
//--------------------------------------------------------------------
class Nelson_Customize_Info_Control extends WP_Customize_Control {
	public $type = 'info';
...
// 'hidden' field
//--------------------------------------------------------------------
class Nelson_Customize_Hidden_Control extends WP_Customize_Control {
	public $type = 'hidden';
	...
	public function render_content() {
		...
		if ( 'last_option' == $this->id && nelson_storage_get( 'need_footer_scripts', false ) ) {
			nelson_storage_set( 'need_footer_scripts', false );
...
// 'button' field
//--------------------------------------------------------------------
class Nelson_Customize_Button_Control extends WP_Customize_Control {
	public $type = 'button';
...
// 'switch' field
//--------------------------------------------------------------------
class Nelson_Customize_Switch_Control extends WP_Customize_Control {
	public $type = 'switch';
...
// 'icon' field
//--------------------------------------------------------------------
class Nelson_Customize_Icon_Control extends WP_Customize_Control {
	public $type = 'icon';
...
// 'checklist' field
//--------------------------------------------------------------------
class Nelson_Customize_Checklist_Control extends WP_Customize_Control {
...
// 'scheme_editor' field
//--------------------------------------------------------------------
class Nelson_Customize_Scheme_Editor_Control extends WP_Customize_Control {
			...
			/>
				...
				nelson_show_layout(
					nelson_show_custom_field(
						...
						$this->input_attrs,
						nelson_unserialize( $this->input_attrs['value'] )
					)
				);
				?>
			</span>
...
// 'text_editor' field
//--------------------------------------------------------------------
class Nelson_Customize_Text_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		nelson_storage_set( 'need_footer_scripts', true );
	}
}
...
// 'range' field
//--------------------------------------------------------------------
class Nelson_Customize_Range_Control extends WP_Customize_Control {
	public $type = 'range';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			<span class="customize-control-field-wrap"><input type="<?php echo ! $show_value ? 'hidden' : 'text'; ?>" 
				...
				$this->link();
				if ( $show_value ) {
					echo ' class="nelson_range_slider_value"';
				}
				if ( ! empty( $this->input_attrs['var_name'] ) ) {
					echo ' data-var_name="' . esc_attr( $this->input_attrs['var_name'] ) . '"';
				}
