...
if ( class_exists( 'Tribe__Events__Query' ) && has_filter( 'pre_get_posts', array( 'Tribe__Events__Query', 'pre_get_posts' ) ) ) {
	$restore_filter = true;
...
if ( $restore_filter && class_exists( 'Tribe__Events__Query' ) ) {
