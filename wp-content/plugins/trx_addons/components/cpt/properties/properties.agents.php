		...
		register_taxonomy(
			...
			apply_filters('trx_addons_filter_register_taxonomy',
				array(
					...
					'query_var'         => true,
					'rewrite'           => array(
												'slug'         => trx_addons_cpt_param('agents', 'taxonomy_slug'),
												'with_front'   => false,
												'hierarchical' => true
											)
				),
		...
		register_post_type(
			...
			apply_filters('trx_addons_filter_register_post_type',
				array(
					...
					'rewrite'             => array(
												'slug'         => trx_addons_cpt_param('agents', 'post_type_slug'),
												'with_front'   => false,
												'hierarchical' => false
											)
				),
...
if (!function_exists('trx_addons_cpt_agents_options_get_list_choises')) {
	add_filter('trx_addons_filter_options_get_list_choises', 'trx_addons_cpt_agents_options_get_list_choises', 10, 2);
	function trx_addons_cpt_agents_options_get_list_choises($list, $name) {
