	...
	function trx_addons_cpt_cars_get_list_options($add_parameters=array()) {
		return apply_filters('trx_addons_cpt_list_options', array(
				...
				'cars_blog_animation' => array(
					...
					'desc' => wp_kses_data( __( 'Select animation to show posts in the archive. Attention! Do not use any animation on pages with the "wheel to the anchor" behaviour!', 'trx_addons' ) ),
					"dependency" => array(
						"cars_disable" => array(0)
					),
					'std' => 'none',
