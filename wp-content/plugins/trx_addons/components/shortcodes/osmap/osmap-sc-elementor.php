...
if (!function_exists('trx_addons_sc_osmap_add_in_elementor')) {
	add_action( 'elementor/widgets/widgets_registered', 'trx_addons_sc_osmap_add_in_elementor' );
	function trx_addons_sc_osmap_add_in_elementor() {
		...
		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new TRX_Addons_Elementor_Widget_Osmap() );
	}
}
