			...
			protected function _register_controls() {
				...
				$this->add_control(
					...
					[
						...
						'label_block' => false,
						'description' => __( 'To: date above is a finish date. From: date above is a start date', 'trx_addons' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
				...
				$this->add_control(
					...
					[
						...
						'description' => __( 'Specify start value of timer with format "[DD:]HH:MM[:SS]"', 'trx_addons' ),
