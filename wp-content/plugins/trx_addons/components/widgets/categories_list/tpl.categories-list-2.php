		...
		<div class="categories_list_item">
			...
			if ($show_thumbs) {
				...
				?><div class="categories_list_image"><?php
					...
					?><img src="<?php echo esc_url($src); ?>" <?php if (!empty($attr[3])) trx_addons_show_layout($attr[3]); ?> alt="<?php esc_attr_e('Category image', 'trx_addons'); ?>">
				</div><?php
			}
			?><h6 class="categories_list_title"><?php
